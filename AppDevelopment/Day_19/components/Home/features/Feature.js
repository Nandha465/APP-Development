        ...
        <div className={styles.featureContainer}>
          <div className={styles.diverse}>
            <div className={styles.overlay}>
              <span className={styles.title}>Wide variety Pet toys</span>
              <span>
                Diverse selection of pet toys tailored to your pet's
                preferences.
              </span>
            </div>
            <img
        ...
        <div className={styles.featureContainer}>
          <div className={styles.safety}>
            <div className={styles.overlay}>
              ...
              <span>Premium quality pet toys for safety and durability.</span>
            </div>
            <img
              className={styles.imgs}
              src={feature_safety}
        ...
        <div className={styles.featureContainer}>
          <div className={styles.interaction}>
            <div className={styles.overlay}>
              ...
              <span>
                Engage your pet with interactive play for physical and mental
                stimulation.
              </span>
            </div>
            <img
